...
recognition.onresult = function (event) {
  ...
  if(localStorage.getItem("lang") === "en-US"){
    ...
    // jarvis bio
    if (transcript.includes("Tell about yourself") || transcript.includes("tell me about you") || transcript.includes("who are you")) {
      readOut("I am Quantec, a computer program created by मोहम्मद दाऊद, here to assist you, and i extend a warm welcome to you");
    }
    if (transcript.includes("who am i") || transcript.includes("main kaun hoon") || transcript.includes("kaun hoon main")) {
      readOut("First you tell your name, then, I will answer you");
    }
    if (transcript.includes("my name is dawood") || transcript.includes("name is dawood") || transcript.includes("main hoon dawood") || transcript.includes("my name daud") || transcript.includes("my name is daud") || transcript.includes("main daud hun") || transcript.includes("daud hun main") || transcript.includes("tell me about me")) {
      readOut("you are my creator, my master, दाऊद");
    }
    if (transcript.includes("hello contact") || transcript.includes("hello Quantech") || transcript.includes("Quantech") || transcript.includes("hello Quantech") || transcript.includes("contact")) {
      readOut("hello sir");
      // console.log("hello sir");
    }
    if (transcript.includes("hello computer")) {
      readOut("hello sir");
      // console.log("hello sir");
    }
    
    if (transcript.includes("how are you, my dear computer") || transcript.includes("how are you")) {
      readOut("I am fine daood sir, you tell, how about you");
      // console.log("hello sir");
    }
    if (transcript.includes("i also find.")) {
      readOut("nice to hear from you");
      // console.log("hello sir");
    }
    if (transcript.includes("thank you") || transcript.includes("thanks")) {
      readOut("you welcome mr दाऊद");
      // console.log("hello sir");
    }
    if (transcript.includes("can you listen me")) {
      readOut("yes i can you listen properly");
      // console.log("hello sir");
    }
    if (transcript.includes("do you know what is my name")) {
      readOut("your name is दाऊद");
      // console.log("hello sir");
    }
    if (transcript.includes("mein bhee theek hee ho")) {
      readOut("sunakar achchha lagasunkr accha laga");
      // console.log("hello sir");
    }
    if (transcript.includes("love you") || transcript.includes("love") || transcript.includes("i love you")) {
      readOut("hello, this is computer modal. I’m glad you like me, but I’m afraid I can’t reciprocate your feelings. I’m just a computer modal, Which was created by Dawood. , i am not a real person. I hope you understand. ");
      // console.log("hello sir");
    }
  ...
  if(localStorage.getItem("lang") === "hi-IN"){
    if(transcript.includes("हैलो क्वानटेक")){
